...
4. Create a Cloud Pub/Sub topic and publish bucket notifications there:
   $ gsutil notification create -f json -t uptate_topic gs://testbucket

5. Create a subscription for your new topic:
   $ gcloud pubsub subscriptions create update_topic_subscription --topic=uptate_topic
